...
export default function AudioPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
      <div className="min-h-screen bg-neutral-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white mb-4">Audio Not Found</h1>
          <p className="text-neutral-400 mb-6">The audio you're looking for doesn't exist.</p>
          <button
            onClick={() => router.push('/')}
